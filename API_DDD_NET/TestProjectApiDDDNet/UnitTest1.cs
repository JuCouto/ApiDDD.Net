...
namespace TestProjectApiDDDNet
{
    [TestClass]
    public class UnitTest1
    {
        ...
        {
            var result = ChamaApiPost("https://localhost:7145/api/List").Result;
        ...
        public void GetToken()
        {
            ...
            string urlApiGeraToken = "https://localhost:7145/api/CriarTokenIdentity";

            using (var cliente = new HttpClient())
            {
                string login = "jna@mail.com";
                string senha = "@A1234a";
                var dados = new
                {
                    email = login,
